  ...
  return (
    <div className='w-52  bg-white overflow-hidden rounded-md '>
        ...
        <div className='w-full p-3'>
            ...
            <button onClick={()=>handleClick(index)} className={`px-3 py-1 mt-4 rounded-md ${friends ? "bg-green-500" : "bg-red-600"} font-xs text-white font-semibold`}>{friends === true ? "Friends":"Add Friend"}</button>
        </div>
    </div>
  )
}
